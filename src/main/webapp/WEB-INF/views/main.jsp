 ...
 <div class="main-navigation navbar-fixed-top">
  ...
  <div id="banner" class="section-padding">
    <div class="container">
      <div class="row">
        <div class="jumbotron">
          <h1 class="small">Welcome To <span class="bold">GMS</span></h1>
          <p class="big">어떻게 해야할지 모르겠다</p>
          <div id=""><a href="#" class="btn btn-banner">Login<i class="fa fa-send"></i></a></div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="cta-1">
    <div class="container">
      <div class="row text-center white">
        <h1 class="cta-title">NO PAIN NO CODING</h1>
        <p class="cta-sub-title">아무말 대잔치</p>
      </div>
    </div>
  </div>
  <!--CTA1 END-->
    ...
    <div class="container">
      ...
      <div class="row" id="portfolio-wrapper">
        <div class="col-lg-3 col-md-6 portfolio-item filter-app">
          <a href="">
            <img src="${context}/resources/bootstrap/img/portfolio/app1.jpg" alt="">
            <div class="details">
              <h4>App 1</h4>
        ...
        <div class="col-lg-3 col-md-6 portfolio-item filter-web">
          <a href="">
            <img src="${context}/resources/bootstrap/img/portfolio/web2.jpg" alt="">
            <div class="details">
              <h4>Web 2</h4>
              <span>Alored dono par</span>
            </div>
        ...
        <div class="col-lg-3 col-md-6 portfolio-item filter-app">
          <a href="">
            <img src="${context}/resources/bootstrap/img/portfolio/app3.jpg" alt="">
            <div class="details">
              <h4>App 3</h4>
              <span>Alored dono par</span>
            </div>
        ...
        <div class="col-lg-3 col-md-6 portfolio-item filter-card">
          <a href="">
            <img src="${context}/resources/bootstrap/img/portfolio/card1.jpg" alt="">
            <div class="details">
              <h4>Card 1</h4>
              <span>Alored dono par</span>
            </div>
        ...
        <div class="col-lg-3 col-md-6 portfolio-item filter-card">
          <a href="">
            <img src="${context}/resources/bootstrap/img/portfolio/card2.jpg" alt="">
            <div class="details">
              <h4>Card 2</h4>
              <span>Alored dono par</span>
            </div>
        ...
        <div class="col-lg-3 col-md-6 portfolio-item filter-web">
          <a href="">
            <img src="${context}/resources/bootstrap/img/portfolio/web3.jpg" alt="">
            <div class="details">
              <h4>Web 3</h4>
              <span>Alored dono par</span>
            </div>
        ...
        <div class="col-lg-3 col-md-6 portfolio-item filter-card">
          <a href="">
            <img src="${context}/resources/bootstrap/img/portfolio/card3.jpg" alt="">
            <div class="details">
              <h4>Card 3</h4>
              <span>Alored dono par</span>
            </div>
        ...
        <div class="col-lg-3 col-md-6 portfolio-item filter-app">
          <a href="">
            <img src="${context}/resources/bootstrap/img/portfolio/app2.jpg" alt="">
            <div class="details">
              <h4>App 2</h4>
              <span>Alored dono par</span>
            </div>
        ...
        <div class="col-lg-3 col-md-6 portfolio-item filter-logo">
          <a href="">
            <img src="${context}/resources/bootstrap/img/portfolio/logo1.jpg" alt="">
            <div class="details">
              <h4>Logo 1</h4>
              <span>Alored dono par</span>
            </div>
        ...
        <div class="col-lg-3 col-md-6 portfolio-item filter-logo">
          <a href="">
            <img src="${context}/resources/bootstrap/img/portfolio/logo3.jpg" alt="">
            <div class="details">
              <h4>Logo 3</h4>
              <span>Alored dono par</span>
            </div>
        ...
        <div class="col-lg-3 col-md-6 portfolio-item filter-web">
          <a href="">
            <img src="${context}/resources/bootstrap/img/portfolio/web1.jpg" alt="">
            <div class="details">
              <h4>Web 1</h4>
              <span>Alored dono par</span>
            </div>
        ...
        <div class="col-lg-3 col-md-6 portfolio-item filter-logo">
          <a href="">
            <img src="${context}/resources/bootstrap/img/portfolio/logo2.jpg" alt="">
            <div class="details">
              <h4>Logo 2</h4>
              <span>Alored dono par</span>
            </div>
      ...
      <div class="row">
        ...
        <div class="autoplay">
          <div class="col-md-6">
            <div class="team-info">
              <div class="img-sec">
                <img src="${context}/resources/bootstrap/img/agent1.jpg" class="img-responsive">
              </div>
          ...
          <div class="col-md-6">
            <div class="team-info">
              <div class="img-sec">
                <img src="${context}/resources/bootstrap/img/agent2.jpg" class="img-responsive">
              </div>
              <div class="fig-caption">
                <h3>Emmy Brown</h3>
          ...
          <div class="col-md-6">
            <div class="team-info">
              <div class="img-sec">
                <img src="${context}/resources/bootstrap/img/agent3.jpg" class="img-responsive">
              </div>
              <div class="fig-caption">
                <h3>Iain Dante</h3>
                <p class="marb-20">Jr. UI Designer</p>
          ...
          <div class="col-md-6">
            <div class="team-info">
              <div class="img-sec">
                <img src="${context}/resources/bootstrap/img/agent4.jpg" class="img-responsive">
              </div>
              <div class="fig-caption">
                <h3>Kate Haris</h3>
                <p class="marb-20">Jr. UI Designer</p>
...
<script>
	/* documnet.getElementById('login_btn')
	.addEventListner('click',function(){
		alert('하이룽');
	})
	common.main('${context}'); 아래와 같음*/
