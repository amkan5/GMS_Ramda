function contentUI(ctx){
	...
	+'<div class="row" id="portfolio-wrapper">'
	    +'<div class="col-lg-3 col-md-6 portfolio-item filter-app">'
	      +'<a href="">'
	        +'<img src="'+ctx+'/resources/bootstrap/img/portfolio/app1.jpg" alt="">'
	        +'<div class="details">'
	          +'<h4>App 1</h4>'
	...
	+'<div class="col-lg-3 col-md-6 portfolio-item filter-web">'
	      +'<a href="">'
	        +'<img src="'+ctx+'/resources/bootstrap/img/portfolio/web2.jpg" alt="">'
	        +'<div class="details">'
	          +'<h4>Web 2</h4>'
	          +'<span>Alored dono par</span>'
	        +'</div>'
	...
	+'<div class="col-lg-3 col-md-6 portfolio-item filter-app">'
	      +'<a href="">'
	        +'<img src="'+ctx+'/resources/bootstrap/img/portfolio/app3.jpg" alt="">'
	        +'<div class="details">'
	          +'<h4>App 3</h4>'
	          +'<span>Alored dono par</span>'
	        +'</div>'
	...
	+'<div class="col-lg-3 col-md-6 portfolio-item filter-card">'
	      +'<a href="">'
	        +'<img src="'+ctx+'/resources/bootstrap/img/portfolio/card1.jpg" alt="">'
	        +'<div class="details">'
	          +'<h4>Card 1</h4>'
	          +'<span>Alored dono par</span>'
	        +'</div>'
	...
	+'<div class="col-lg-3 col-md-6 portfolio-item filter-card">'
	      +'<a href="">'
	        +'<img src="'+ctx+'/resources/bootstrap/img/portfolio/card2.jpg" alt="">'
	        +'<div class="details">'
	          +'<h4>Card 2</h4>'
	          +'<span>Alored dono par</span>'
	        +'</div>'
	...
	+'<div class="col-lg-3 col-md-6 portfolio-item filter-web">'
	      +'<a href="">'
	        +'<img src="'+ctx+'/resources/bootstrap/img/portfolio/web3.jpg" alt="">'
	        +'<div class="details">'
	          +'<h4>Web 3</h4>'
	          +'<span>Alored dono par</span>'
	        +'</div>'
	...
	+'<div class="col-lg-3 col-md-6 portfolio-item filter-card">'
	      +'<a href="">'
	        +'<img src="'+ctx+'/resources/bootstrap/img/portfolio/card3.jpg" alt="">'
	        +'<div class="details">'
	          +'<h4>Card 3</h4>'
	          +'<span>Alored dono par</span>'
	        +'</div>'
	...
	+'<div class="col-lg-3 col-md-6 portfolio-item filter-app">'
	      +'<a href="">'
	        +'<img src="'+ctx+'/resources/bootstrap/img/portfolio/app2.jpg" alt="">'
	        +'<div class="details">'
	          +'<h4>App 2</h4>'
	          +'<span>Alored dono par</span>'
	        +'</div>'
	...
	+'<div class="col-lg-3 col-md-6 portfolio-item filter-logo">'
	      +'<a href="">'
	        +'<img src="'+ctx+'/resources/bootstrap/img/portfolio/logo1.jpg" alt="">'
	        +'<div class="details">'
	          +'<h4>Logo 1</h4>'
	          +'<span>Alored dono par</span>'
	        +'</div>'
	...
	+'<div class="col-lg-3 col-md-6 portfolio-item filter-logo">'
	      +'<a href="">'
	        +'<img src="'+ctx+'/resources/bootstrap/img/portfolio/logo3.jpg" alt="">'
	        +'<div class="details">'
	          +'<h4>Logo 3</h4>'
	          +'<span>Alored dono par</span>'
	        +'</div>'
	...
	+'<div class="col-lg-3 col-md-6 portfolio-item filter-web">'
	      +'<a href="">'
	        +'<img src="'+ctx+'/resources/bootstrap/img/portfolio/web1.jpg" alt="">'
	        +'<div class="details">'
	          +'<h4>Web 1</h4>'
	          +'<span>Alored dono par</span>'
	        +'</div>'
	...
	+'<div class="col-lg-3 col-md-6 portfolio-item filter-logo">'
	      +'<a href="">'
	        +'<img src="'+ctx+'/resources/bootstrap/img/portfolio/logo2.jpg" alt="">'
	        +'<div class="details">'
	          +'<h4>Logo 2</h4>'
	          +'<span>Alored dono par</span>'
	        +'</div>'
	  ...
	  +'<div class="row">'
	    ...
	    +'<div class="autoplay">'
	      +'<div class="col-md-6">'
	        +'<div class="team-info">'
	          +'<div class="img-sec">'
	            +'<img src="'+ctx+'/resources/bootstrap/img/agent1.jpg" class="img-responsive">'
	          +'</div>'
	      ...
	      +'<div class="col-md-6">'
	        +'<div class="team-info">'
	          +'<div class="img-sec">'
	            +'<img src="'+ctx+'/resources/bootstrap/img/agent2.jpg" class="img-responsive">'
	          +'</div>'
	          +'<div class="fig-caption">'
	            +'<h3>Emmy Brown</h3>'
	      ...
	      +'<div class="col-md-6">'
	        +'<div class="team-info">'
	          +'<div class="img-sec">'
	            +'<img src="'+ctx+'/resources/bootstrap/img/agent3.jpg" class="img-responsive">'
	          +'</div>'
	          +'<div class="fig-caption">'
	            +'<h3>Iain Dante</h3>'
	            +'<p class="marb-20">Jr. UI Designer</p>'
	      ...
	      +'<div class="col-md-6">'
	        +'<div class="team-info">'
	          +'<div class="img-sec">'
	            +'<img src="'+ctx+'/resources/bootstrap/img/agent4.jpg" class="img-responsive">'
	          +'</div>'
	          +'<div class="fig-caption">'
	            +'<h3>Kate Haris</h3>'
	            +'<p class="marb-20">Jr. UI Designer</p>'
